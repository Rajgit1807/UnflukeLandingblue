...
const handleCaptchaChange = (value: string | null): void => {
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: 'Email',
      details: 'aseem12321@gmail.com',
      description: 'Send us an email anytime!'
    },
    {
      icon: Phone,
      title: 'Phone',
      details: '+91 88006 83154',
      description: 'Mon-Fri from 8am to 5pm'
    },
    {
      icon: MapPin,
      title: 'Office',
      details: 'A 99 Sector 65 Noida, New Delhi, India',
  ...
  const faqs = [
    ...
    {
      question: 'Can I schedule a call with Aseem?',
      answer: 'Yes! For course related questions, you can drop Aseem an email with all your doubts.'
    },
    {
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      ></textarea>
                       ...
                       <ReCAPTCHA
                        sitekey="6LehVXcrAAAAANOB63r91reztWb-II9didBU7SJy"  // Replace with your reCAPTCHA site key
  ...
  className={`w-full py-4 px-6 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2
    ${isVerified && !loading ? 'bg-blue-600 text-white hover:bg-blue-700' : 'bg-blue-600 text-white opacity-50 cursor-not-allowed'}`}
>
  {loading ? (
    ...
    <>
      ...
      Send Message
          ...
          <div className="space-y-8">
            ...
            {/* Emergency Contact */}
            <div className="bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 rounded-2xl p-6 text-white">
              ...
              <button className="bg-white text-[#2563EB] px-4 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-sm">
                Start Live Chat
              </button>
            </div>
          </div>
