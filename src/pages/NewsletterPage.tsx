    ...
    <div className="pt-20 min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-blue-50">
                ...
                <div className="flex gap-4">
                  <div className="flex-1 relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-4 border border-gray-200 rounded-full focus:outline-none focus:border-blue-500 transition-colors text-lg"
                      required
                    />
                  </div>
                  <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="text-center">
            <div className="text-3xl font-bold text-[#2563EB] mb-2">5K+</div>
