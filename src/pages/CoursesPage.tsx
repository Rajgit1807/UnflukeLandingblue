...
const courses = [
  ...
  },
  {
    ...
    tags: ['Stock Market', 'IPO', 'Demat', 'Equity', 'India Market'],
    isNew: false,
    isPopular: false
  }
];
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
            ...
            <select
              ...
              className="border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:border-blue-500 transition-colors"
            >
            ...
            >
              <div className="relative">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition-all duration-300 flex items-center justify-center">
                  <div className="w-16 h-16 bg-white bg-opacity-0 group-hover:bg-opacity-90 rounded-full flex items-center justify-center transition-all duration-300">
                    <Play className="w-8 h-8 text-[#2563EB] opacity-0 group-hover:opacity-100 transition-opacity duration-300 ml-1" />
                  </div>
                </div>
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm font-medium text-[#2563EB]">{course.category}</span>
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-[#2563EB] transition-colors line-clamp-2">
                  {course.title}
                </h3>
