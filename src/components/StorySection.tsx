...
const timeline = [
  ...
  return (
    <section id="story-section" className="py-20 bg-gradient-to-br from-blue-50 to-purple-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
            Hello, I'm <span className="text-[#2563EB]">Aseem Singhal</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-12">
            {/* My Story */}
            <div>
              <h3 className="text-2xl font-bold text-[#2563EB] mb-6">My Story</h3>
            ...
            <div>
              <h3 className="text-2xl font-bold text-[#2563EB] mb-6">Educational Background</h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {achievements.map((achievement, index) => (
                <div key={index} className="text-center bg-white rounded-2xl p-6 shadow-sm">
                  <div className="text-3xl font-bold text-[#2563EB] mb-1">{achievement.number}</div>
            ...
            <div className="text-center lg:text-left">
              <Link
                to="/courses"
                className="inline-flex items-center bg-blue-600 text-white px-8 py-4 rounded-full font-semibold hover:bg-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
          ...
          <div>
            <h3 className="text-2xl font-bold text-[#2563EB] mb-8 text-center lg:text-left">My Experience</h3>
              ...
              <div className="space-y-8">
                {timeline.map((item, index) => (
                  <div key={index} className="relative flex items-start gap-6">
                    {/* Timeline Dot */}
                    <div className="relative z-10 w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center border-4 border-white shadow-sm">
                    ...
                    <div className="flex-1 bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                      <div className="flex items-center gap-3 mb-3">
                        <span className="text-sm font-bold text-[#2563EB] bg-blue-100 px-3 py-1 rounded-full">
                          {item.year}
                        </span>
                        {item.year === 'Now' && (
